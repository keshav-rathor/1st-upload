...
if __name__ == '__main__':
    ...
    bsvm_train_path = 'echo' #'/home/zquan/libsvm/svm-train'
    bsvm_predict_path = 'echo' # '/home/zquan/libsvm/svm-predict'
    ...
    for i in range(NUM_LABELS):
        cmd_runs = []
        input_path = oned_binary_dir + 'data_fc%d_label%d_%s' % (FC_LAYER, i, DATASET)
        output_path_prefix = oned_binary_dir + 'runs/model_fc%d_label%d' % (FC_LAYER, i)
        input_path_val = oned_binary_dir + 'data_fc%d_label%d_%s' % (FC_LAYER, i, DATASET_VAL)
        output_path_val_prefix = oned_binary_dir + 'runs/predict_fc%d_label%d' % (FC_LAYER, i)
        logpath = oned_binary_dir + 'output_label_%d' % i
        ...
        svm_run = SVMThread(cmd_runs, logpath)
