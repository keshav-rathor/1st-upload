...
from nn_dual import model
from nn_dual import nn_input

FLAGS = tf.app.flags.FLAGS

tf.app.flags.DEFINE_string('architecture', '5layer_dual_dropout',
...
def evaluate(data_dir='', ids=None, fcout=False):
  ...
  with tf.Graph().as_default() as g:
    if ids is None:
      ...
      keys_op, images, oneds, labels = model.inputs(eval_data=eval_data)
      if eval_data:
    ...
    # inference model.
    _, _, logits, _ = model.inference(images, oneds,
