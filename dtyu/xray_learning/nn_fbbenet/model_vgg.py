  ...
  """
    ...
    if architecture == 'cnn':
        ...
        with tf.variable_scope('fconv1') as scope:
            ...
            ffilter_layer1 = tf.split(axis=0, num_or_size_splits=ffilter_layer1_height, value=ffilter_layer1)
            for height_idx in range(0, ffilter_layer1_height):
                ...
                tmp = tf.split(axis=0, num_or_size_splits=ffilter_layer1_width,
                               value=ffilter_layer1[height_idx])
                for width_idx in range(0, ffilter_layer1_width):
                    ...
                    tmp[width_idx] = tf.concat(axis=2, values=[tmp[width_idx], empty_dim])
                ffilter_layer1[height_idx] = tf.concat(axis=0, values=tmp)
            ffilter_layer1 = tf.concat(axis=1, values=ffilter_layer1)
