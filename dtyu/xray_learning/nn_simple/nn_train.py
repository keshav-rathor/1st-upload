...
"""Simple 3-level NN model modified from tf mnist example."""
...
import nn_simple.nn_simple as model
import tagio.dataset_loader as loader
...
def run_training():
  ...
  data_sets = loader.read_data_sets(data, tags, 'Halo')
  ...
  with tf.Graph().as_default():
    ...
    for step in xrange(FLAGS.max_steps):
      ...
      if step % 10 == 0:
        ...
        #logits_eval_op = sess.run(logits, feed_dict=feed_dict)
        #print(logits_eval_op)
