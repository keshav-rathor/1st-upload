...
def inputs(eval_data, num_threads=16, input_override=None, num_examples=0):
  ...
  return nn_input.inputs(eval_data=eval_data, data_dir=data_dir,
                         ...
                         input_override=input_override, num_examples=num_examples)


def inference(images, oneds, dropout=False, keep_prob=0.5):
  ...
  with tf.variable_scope('local4') as scope:
    ...
    concat_tensor = tf.concat(1, [reshape, oneds])
